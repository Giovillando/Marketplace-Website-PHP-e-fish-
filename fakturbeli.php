...
<br>
<?php
$ambil=$koneksi->query("SELECT * FROM faktur_beli JOIN pembeli on faktur_beli.ID_Pembeli=pembeli.ID_Pembeli JOIN kota on pembeli.ID_Kota_Pembeli=kota.ID_Kota
...
<p align =left><h6>  
ID Faktur Beli    : <?php echo $detailll['ID_Faktur_Beli']; ?> <br>
...
Jasa Pembayaran  : <?php echo $detailll['Nama_Jasa_Pembayaran'];?> <br> </h6></p>
  ...
  <div class="col-md-6">
    <h5><strong>Pembeli</strong></h5>
  <p align=right><h6>  
  Nama      : <?php echo $detail['Nama_Pembeli']; ?> <br>
  Alamat Lengkap  : <?php echo $detail['Alamat_Pembeli'];?> <br>
  No HP       : <?php echo $detail['No_Handphone_Pembeli'];?> <br> 
			...
			<div class="row">
				<div class="col-md-12">
					<div class="alert alert-info">
						...
						<strong>Nomor Pembayaran : <?php echo $detailll['No_Pembayaran']; ?>  </strong></p>
						<strong><?php echo $detailll['Nama_Jasa_Pembayaran']; ?> : <?php echo $detaill['No_Rekening_Penjual']; ?>  </strong></p>
					</div>
				</div>
			</div>
...
<?php endif ?>
	...
	<center><button type="button" class="btn btn-success btn-rounded btn-fw" 
           onclick="location.href='riwayatpembayaran.php'" data-toggle="tooltip" data-placement="top" title="Selanjutnya">
          Selanjutnya
          </button></center>
</section>
</body>
