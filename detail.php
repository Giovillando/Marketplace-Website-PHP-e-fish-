...
$ambil=$koneksi->query("SELECT * FROM barang join kelompok_barang on barang.Kode_Kelompok_Barang=kelompok_barang.Kode_Kelompok_Barang join jenis_barang on kelompok_barang.Kode_Jenis_Barang=jenis_barang.Kode_Jenis_Barang join penjual on barang.ID_Penjual=penjual.ID_Penjual
	...
	<section class="container py-1">
		<div class="row">
			...
			<div class="col-md-6">
				...
				<h5> Kelompok Barang : <?php echo $detail["Nama_Kelompok_Barang"] ?> </h5
