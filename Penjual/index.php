				...
				<div id="page-wrapper">
					<div id="page-inner">
						...
						if (isset($_GET['halaman']))
						{
							...
							elseif($_GET['halaman']=="laporanpenjualan1")
							{
								include 'laporanpenjualan1.php';
							}
							elseif($_GET['halaman']=="laporanpenjualan2")
							{
								include 'laporanpenjualan2.php';
							}
							elseif($_GET['halaman']=="laporanpenjualan3")
							{
								include 'laporanpenjualan3.php';
							}
							elseif($_GET['halaman']=="laporanrating")
							{
