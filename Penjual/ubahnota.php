...
<form method="post" enctype="multipart/form-data">
	<div class="form-group">
		<label>NO Nota</label>
		<input type="text" class="form-control" name="No_Nota" value="<?php echo $pecah['No_Nota'];?>">
	</div>
	<div class="form-group">
		<label>Tanggal Pemesanan</label>
		<input type="date" class="form-control" name="Tgl_Pesan" value="<?php echo $pecah['Tgl_Pesan'];?>">
	</div>
	<div class="form-group">
		<label>Pembeli</label>
...
if(isset ($_POST['ubah']))
{
	$koneksi->query("UPDATE nota SET No_Nota='$_POST[No_Nota]',Tgl_Pesan='$_POST[Tgl_Pesan]',
		ID_Pembeli='$_POST[ID_Pembeli]',ID_Pembayaran='$_POST[ID_Pembayaran]',ID_Statkirim='$_POST[ID_Statkirim]',
		ID_Statbayar='$_POST[ID_Statbayar]',ID_Tagihan='$_POST[ID_Tagihan]',ID_Pengiriman='$_POST[ID_Pengiriman]'
