...
<form method="post" enctype="multipart/form-data">
	...
	<div class="form=group">
		...
		<input type="text" class="form-control" name="Tanggal_Barang_Masuk" value="<?php echo $pecah['Tanggal_Barang_Masuk'];?>">
	</div>
	<div class="form=group">
...
if(isset ($_POST['ubah']))
{
	...
	$koneksi->query("UPDATE barang SET Kode_Barang='$_POST[Kode_Barang]',Tanggal_Barang_Masuk='$_POST[Tanggal_Barang_Masuk]',Nama_Barang='$_POST[Nama_Barang]',Berat_Barang='$_POST[Berat_Barang]',Deskripsi_Barang='$_POST[Deskripsi]',Harga_Barang='$_POST[Harga]',
