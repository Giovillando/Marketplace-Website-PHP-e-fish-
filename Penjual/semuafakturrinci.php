<h2> NOTA </h2>
<a href="index.php?halaman=nota" class="btn btn-success square-btn-adjust"><i class="fa fa-refresh"></i> Refresh
				</a><table class="table table-bordered"background="23.jpg">
	<thead>
		<tr>
			<th>NO Nota</th>
	...
	<tbody>
		<?php $ambil=$koneksi->query("SELECT*FROM nota 
