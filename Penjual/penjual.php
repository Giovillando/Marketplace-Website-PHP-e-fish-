<div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                            ...
                                            ?>
                                               <tr>
                                                   ...
                                                   <td><?php echo $db['ID_Penjual'];?></td>
                                                    ...
                                                    <td>  <a href ="hapuspenjual.php?ID_Penjual=<?php echo $db['ID_Penjual']?>" onclick ="return confirm ('Apakah anda yakin ingin menghapus data?')"name="hapus" class="btn btn-danger">Delete</a>   
                                                    <a href ="ubahpenjual.php?halaman=ubahpenjual&ID_Penjual=<?php echo $db['ID_Penjual']?>" class="btn btn- btn-info">Edit</a>
                                        <?php $No++;
                                        }
                                        ?> 
                                        </tbody>
                                ...
                                <a href="index.php?halaman=tambahpenjual" class = "btn btn-primary"> Tambah Data </a>
                            </div>