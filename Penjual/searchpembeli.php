...
<div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                    ...
                                    <?php while($pecah = $ambildata->fetch_assoc()){?>
                                               <tr>
                                                   ...
                                                   <td><?php echo $pecah['ID_Pembeli'];?></td>
                                                    ...
                                                    <td>  <a href ="hapuspembeli.php?ID_Pembeli=<?php echo $pecah['ID_Pembeli']?>" onclick ="return confirm ('Apakah anda yakin ingin menghapus data?')"name="hapus" class="btn btn-danger">Delete</a>   
                                                    <a href ="ubahpembeli.php?halaman=ubahpembeli&ID_Pembeli=<?php echo $pecah['ID_Pembeli']?>" class="btn btn- btn-info">Edit</a>
                                        <?php $No++;
                                        }
                                        ?> 
                                        </tbody>
                                ...
                                <a href="tambahpembeli.php?halaman=tambahpembeli" class = "btn btn-primary"> Tambah Data </a>
                            </div>