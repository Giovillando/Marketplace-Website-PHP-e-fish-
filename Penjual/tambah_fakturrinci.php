...
if (isset ( $_POST['save']))
{
    ...
    VALUES ('$_POST[ID_Faktur_Rinci]','$_POST[ID_Faktur_Beli]', '$_POST[ID_Status_Pengiriman]','$_POST[Tanggal]' ,'$_POST[Kode_Daftar_Pengiriman]','$_POST[ID_Status_Transfer_Penjual]', '$_POST[ID_Penjual]','$_POST[Transfer_Uang_Penjual]' ,'$_POST[QTY_Barang_Per_Toko]','$_POST[Total_Rinci]')");
