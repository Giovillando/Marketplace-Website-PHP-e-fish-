...
if(isset($_POST["lihat"]))
{
    ...
    $ambil=$koneksi->query("SELECT *, count(rating) AS jumlah_rating FROM faktur_rinci JOIN penjual on faktur_rinci.ID_Penjual=penjual.ID_Penjual
          ...
          Join pembeli on faktur_beli.ID_Pembeli=pembeli.ID_Pembeli 
                            WHERE rating='$status' AND penjual.ID_Penjual='$penjual'  ");
