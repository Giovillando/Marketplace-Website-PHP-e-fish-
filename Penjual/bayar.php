...
JOIN pembeli ON faktur_beli.ID_Pembeli=pembeli.ID_Pembeli
		...
		JOIN diskon ON faktur_beli.Kode_Diskon=diskon.Kode_Diskon WHERE faktur_beli.ID_Faktur_Beli='$_GET[id]' ");
...
<div class="row">
	<div class="col-md-6"></div>
			...
			<tr>
                ...
                <td><?php echo $detail['Jenis_Diskon'];?></td>
...
<form method="post">
	<div class = "form-group">
		...
		<select class="form-control" name="status_pembayaran">
			...
			<option value="STP102">Sudah Bayar</option>
            <option value="STP103">Pembayaran Sedang Diverifikasi</option>
			<option value="STP104">Pembayaran Ditolak</option>
		</select>
	</div>
