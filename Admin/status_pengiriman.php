                                    ...
                                    while ( $db=mysqli_fetch_array ($ambildata,)){
                                            ?>
                                               ...
                                               <td><?php echo $db['Ket_Status_Pengiriman'];?></td>
                                                    ...
                                                    <td>  <a href ="del_statuspengiriman.php?ID_Status_Pengiriman=<?php echo $db['ID_Status_Pengiriman']?>" onclick ="return confirm ('Apakah anda yakin ingin menghapus data?')"name="hapus" class="btn btn-danger">Delete</a>   
                                                    <a href ="edit_statuspengiriman.php?halaman=edit_statuspengiriman&ID_Status_Pengiriman=<?php echo $db['ID_Status_Pengiriman']?>" class="btn btn- btn-info">Edit</a>
                                        <?php $No++;
                                        }
                                        ?> 
                                        </tbody>
