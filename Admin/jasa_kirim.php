                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <?php $nomor=1; ?>
                                        ...
                                        <?php while ($pecah=$ambil->fetch_assoc()){ ?>
                                               ...
                                               <td><?php echo $pecah['Nama_Jasa_Kirim'];?></td>
                                                    ...
                                                    <td>  <a href ="del_jasakirim.php?ID_Jasa_Kirim=<?php echo $db['ID_Jasa_Kirim']?>" onclick ="return confirm ('Apakah anda yakin ingin menghapus data?')"name="hapus" class="btn btn-danger">Delete</a>   
                                                    <a href ="edit_jasakirim.php?halaman=edit_jasakirim&ID_Jasa_Kirim=<?php echo $db['ID_Jasa_Kirim']?>" class="btn btn- btn-info">Edit</a>
                                        <?php $nomor++;
                                        }
                                        ?> 
                                        </tbody>
                                ...
                                <a href="index.php?halaman=tambah_jasakirim" class = "btn btn-primary"> Tambah Data </a>
                            </div>