...
$query="SELECT * FROM barang JOIN Kelompok_barang ON barang.Kode_Kelompok_Barang=kelompok_barang.Kode_Kelompok_Barang JOIN penjual ON barang.ID_Penjual=penjual.ID_Penjual JOIN kota ON penjual.ID_Kota=kota.ID_Kota $strw AND Tanggal_Barang_Masuk BETWEEN '$tgl_mulai' AND '$tgl_selesai'";
