...
$query="SELECT *FROM faktur_beli  JOIN pembeli ON faktur_beli.ID_Pembeli=pembeli.ID_Pembeli 
     ...
     $strw AND Tanggal_Faktur_Beli BETWEEN '$tgl_mulai' AND '$tgl_selesai'";
    ...
    <tbody>
        ...
        <tr>
            ...
            <td> 
                         ...
                         <a href ="edit_fakturbeli.php?ID_Faktur_Beli=<?php echo $pecah['ID_Faktur_Beli']?>" onclick ="return confirm ('Apakah anda yakin ingin mengedit data?')"name="hapus" class="btn btn-warning">Edit</a> 
