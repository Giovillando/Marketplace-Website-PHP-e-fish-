...
$jmlget =0;
     if(isset($_GET['kelompok'])){
      ...
      $strc[] = "kelompok_barang.Kode_Kelompok_Barang= '$kelompok'";
      $jmlget++;
    }
...
if(!empty($dt1) && !empty($dt2))
{
    ...
    where  (Tanggal BETWEEN '$dt1' AND '$dt2') GROUP BY kelompok_barang.Kode_Kelompok_Barang order by Jumlah desc limit 10");
...
if(!empty($_POST['kelompok']) && !empty($dt1) && !empty($dt2))
{
    ...
    where (Tanggal BETWEEN '$dt1' AND '$dt2' AND Nama_Kelompok_Barang= '$kelompok') 
