<div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                    ...
                                    while ( $db=mysqli_fetch_array ($ambildata,)){
                                            ?>
                                               ...
                                               <td><?php echo $db['Nama_Jenis_Barang'];?></td>
                                                    ...
                                                    <td>  <a href ="del_jenisbarang.php?Kode_Jenis_Barang=<?php echo $db['Kode_Jenis_Barang']?>" onclick ="return confirm ('Apakah anda yakin ingin menghapus data?')"name="hapus" class="btn btn-danger">Delete</a>   
                                                    <a href ="edit_jenisbarang.php?halaman=edit_jenisbarang&Kode_Jenis_Barang=<?php echo $db['Kode_Jenis_Barang']?>" class="btn btn- btn-info">Edit</a>
                                        <?php $No++;
                                        }
                                        ?> 
                                        </tbody>
                                ...
                                <a href="index.php?halaman=tambah_jenisbarang" class = "btn btn-primary"> Tambah Data </a>
                            </div>