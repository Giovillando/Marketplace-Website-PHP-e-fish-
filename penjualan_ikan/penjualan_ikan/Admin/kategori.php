                                    ...
                                    while ( $db=mysqli_fetch_array ($ambildata,)){
                                            ?>
                                               ...
                                               <td><?php echo $db['Nama_Kategori'];?></td>
                                                    ...
                                                    <td>  <a href ="del_kategori.php?ID_Kategori=<?php echo $db['ID_Kategori']?>" onclick ="return confirm ('Apakah anda yakin ingin menghapus data?')"name="hapus" class="btn btn-danger">Delete</a>   
                                                    <a href ="edit_kategori.php?halaman=edit_kategori&ID_Kategori=<?php echo $db['ID_Kategori']?>" class="btn btn- btn-info">Edit</a>
                                        <?php $No++;
                                        }
                                        ?> 
                                        </tbody>
