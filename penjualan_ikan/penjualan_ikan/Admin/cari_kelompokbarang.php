...
$query=mysqli_query($koneksi, "SELECT * FROM kelompok_barang WHERE Kode_Kelompok_Barang LIKE '%$keyword%'")
...
<div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <tbody>
                                       <?php $No=1; ?>
                                    <?php $ambildata=$koneksi->query("SELECT * FROM kelompok_barang WHERE 
                                Kode_Kelompok_Barang LIKE '%$keyword%' OR
                                Kode_Jenis_Barang LIKE '%$keyword%' OR
                                Nama_Kelompok_Barang LIKE '%$keyword%'");?>
                                    <?php while($pecah = $ambildata->fetch_assoc()){?>
                                               <tr>
                                                   ...
                                                   <td><?php echo $pecah['Kode_Kelompok_Barang'];?></td>
                                                    ...
                                                    <td>  <a href ="index.php?halaman=del_sistempengiriman=<?php echo $db['Kode_Kelompok_Barang']?>" onclick ="return confirm ('Apakah anda yakin ingin menghapus data?')"name="hapus" class="btn btn-danger">Delete</a>   
                                                    <a href ="index.php?halaman=edit_sistempengiriman=<?php echo $db['Kode_Kelompok_Barang']?>" class="btn btn- btn-info">Edit</a>
                                        <?php $No++;
                                        }
                                        ?> 
                                        </tbody>
