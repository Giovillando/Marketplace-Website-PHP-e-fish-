<div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-dark">Data Jasa Pembayaran</h6>
                                    ...
                                    <form class="form-inline" role="search" method="post" action="index.php?halaman=searchjasapembayaran">
                                    <div class="col-10">
                                    <table border="0">
                                    <tr>
                        ...
                        <div class="card-body">
                           <div class="table-responsive">
                                            ...
                                            ?>
                                               <tr>
                                                   ...
                                                   <td><?php echo $db['ID_Jasa_Pembayaran'];?></td>
                                                    ...
                                                    <td>  <a href ="hapusasapembayaran.php?ID_Jasa_Pembayaran=<?php echo $db['ID_Jasa_Pembayaran']?>" onclick ="return confirm ('Apakah anda yakin ingin menghapus data?')"name="hapus" class="btn btn-danger">Delete</a>   
                                                    <a href ="ubahasapembayaran.php?halaman=ubahasapembayaran&ID_Jasa_Pembayaran=<?php echo $db['ID_Jasa_Pembayaran']?>" class="btn btn- btn-info">Edit</a>
                                        <?php $No++;
                                        }
                                        ?> 
                                        </tbody>
                                ...
                                <a href="index.php?halaman=tambahjasapembayaran" class = "btn btn-primary"> Tambah Data </a>
                            </div>