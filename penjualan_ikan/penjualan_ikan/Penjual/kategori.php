<div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                    ...
                                    while ( $db=mysqli_fetch_array ($ambildata,)){
                                            ?>
                                               ...
                                               <td><?php echo $db['Nama_Kategori'];?></td>
                                                    ...
                                                    <td>  <a href ="hapuskategori.php?ID_Kategori=<?php echo $db['ID_Kategori']?>" onclick ="return confirm ('Apakah anda yakin ingin menghapus data?')"name="hapus" class="btn btn-danger">Delete</a>   
                                                    <a href ="ubahkategori.php?halaman=edit_kategori&ID_Kategori=<?php echo $db['ID_Kategori']?>" class="btn btn- btn-info">Edit</a>
                                        <?php $No++;
                                        }
                                        ?> 
                                        </tbody>
                                ...
                                <a href="index.php?halaman=tambahkategorijasa" class = "btn btn-primary"> Tambah Data </a>
                            </div>