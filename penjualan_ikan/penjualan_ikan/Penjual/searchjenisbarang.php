...
<div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-dark">Data Jenis Barang</h6>
                                    ...
                                    <form class="form-inline" role="search" method="post" action="index.php?halaman=searchjenisbarang">
                                    <div class="col-10">
                                    <table border="0">
                                    <tr>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                Nama_Jenis_Barang LIKE '%$keyword%'");?>
                                    <?php while($pecah = $ambildata->fetch_assoc()){?>
                                               ...
                                               <td><?php echo $pecah['Nama_Jenis_Barang'];?></td>
                                                    ...
                                                    <td>  <a href ="hapusjenisbarang.php?Kode_Jenis_Barang=<?php echo $pecah['Kode_Jenis_Barang']?>" onclick ="return confirm ('Apakah anda yakin ingin menghapus data?')"name="hapus" class="btn btn-danger">Delete</a>   
                                                    <a href ="ubahjenisbarang.php?halaman=ubahjenisbarang&Kode_Jenis_Barang=<?php echo $pecah['Kode_Jenis_Barang']?>" class="btn btn- btn-info">Edit</a>
                                        <?php $No++;
                                        }
                                        ?> 
                                        </tbody>
                                ...
                                <a href="tambahjenisbarang.php?halaman=tambahjenisbarang" class = "btn btn-primary"> Tambah Data </a>
                            </div>