...
$query="SELECT * FROM faktur_rinci JOIN  faktur_beli ON faktur_rinci.ID_Faktur_Beli=faktur_beli.ID_Faktur_Beli JOIN
         ...
         faktur_rinci.ID_Penjual =penjual.ID_Penjual $strw AND penjual.ID_Penjual='$penjual' AND faktur_rinci.Tanggal BETWEEN '$tgl_mulai' AND '$tgl_selesai'";
         ...
         <?php while($pecah=$result->fetch_assoc()){?>
            ...
            <td> 
             ...
             <a href ="del_fakturbeli.php?ID_Faktur_Rinci=<?php echo $pecah['ID_Faktur_Rinci']?>" onclick ="return confirm ('Apakah anda yakin ingin menghapus data?')"name="hapus" class="btn btn-danger">Delete</a>  
                      ...
                      <a href="index.php?halaman=lihat_penilaian&id=<?php echo $pecah['ID_Faktur_Rinci']?>" class="btn btn-info">Lihat Komplain</a>
                        <?php endif?>

                        <?php if($pecah['Ket_Status_Pengiriman']=="Barang Diterima" AND  $pecah['Ket_Status_Transfer_Penjual']=="Belum Ditransfer" ):?>
                      <a href="index.php?halaman=detailfakturrinci&id=<?php echo $pecah['ID_Faktur_Rinci']?>" class="btn btn-info">Detail</a>
                      <a href="index.php?halaman=lihat_penilaian&id=<?php echo $pecah['ID_Faktur_Rinci']?>" class="btn btn-success">Lihat Penilaian</a>
                        <?php endif?>

                        <?php if($pecah['Ket_Status_Pengiriman']=="Barang Diterima" AND  $pecah['Ket_Status_Transfer_Penjual']=="Sudah Ditransfer" ):?>
                          <a href="index.php?halaman=lihat_penilaian&id=<?php echo $pecah['ID_Faktur_Rinci']?>" class="btn btn-info">Lihat Penilaian</a>
                        <?php endif?>
