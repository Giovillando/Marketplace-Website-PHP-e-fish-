<div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-dark">DETAIL PENGIRIMAN</h6>
                        </div>
</div>
    </div>              
<!-- /. ROW  -->
...
<div class="row">
	<div class="col-md-6"></div>
			...
			<tr>
                ...
                <td><?php echo $detail['Tarif_Pengiriman'];?></td>
...
<form method="post">
	<div class = "form-group">
		...
		<select class="form-control" name="status_pengiriman">
			...
			<option value="SPENG1">Barang Dikirim</option>
			<option value="SPENG2">Belum Dikirim</option>
            <option value="SPENG3">Selesai</option>
            <option value="SPENG4">Barang Diterima</option>
