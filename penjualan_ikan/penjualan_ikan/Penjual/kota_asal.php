<div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                    ...
                                    while ( $db=mysqli_fetch_array ($ambildata,)){
                                            ?>
                                               ...
                                               <td><?php echo $db['Nama_Kota'];?></td>
                                                    ...
                                                    <td>  <a href ="hapuskotaasal.php?ID_Kota=<?php echo $db['ID_Kota']?>" onclick ="return confirm ('Apakah anda yakin ingin menghapus data?')"name="hapus" class="btn btn-danger">Delete</a>   
                                                    <a href ="ubahkotaasal.php?halaman=ubahkotaasal&ID_Kota=<?php echo $db['ID_Kota']?>" class="btn btn- btn-info">Edit</a>
                                        <?php $No++;
                                        }
                                        ?> 
                                        </tbody>
                                ...
                                <a href="index.php?halaman=tambah_kotaasal" class = "btn btn-primary"> Tambah Data </a>
                            </div>